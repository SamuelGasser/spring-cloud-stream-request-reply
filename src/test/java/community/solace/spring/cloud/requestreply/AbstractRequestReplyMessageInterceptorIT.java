...
import static community.solace.spring.cloud.requestreply.AbstractRequestReplyMessageInterceptorIT.PROFILE_TEST_MESSAGE_INTERCEPTOR;
import static community.solace.spring.cloud.requestreply.AbstractRequestReplyMessageInterceptorIT.PROFILE_LOCAL_APP;
import static org.junit.jupiter.api.Assertions.assertFalse;

@ActiveProfiles({PROFILE_TEST_MESSAGE_INTERCEPTOR, PROFILE_LOCAL_APP})
@SpringBootTest()
...
public abstract class AbstractRequestReplyMessageInterceptorIT {
